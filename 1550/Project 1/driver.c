...
int main() {
	...
	do {
		...
		sleep_ms(500);
		draw_rect(x,y,x+10,y+10,0xF81F);
		sleep_ms(500);
		draw_rect(x+10,y+10,x+10,y+20,0xFFE0);
		sleep_ms(500);
		draw_rect(x+10,y+20,x,y+30,0x79E0);
		sleep_ms(500);
		draw_rect(x,y+30,x-10,y+20,0x001F);
		sleep_ms(500);
		draw_rect(x-10,y+20,x-10,y+10,0xFBE0);
		sleep_ms(500);
		draw_rect(x-10,y+10,x,y,0xBDF7);
		sleep_ms(700);
		clear_screen();
	} while (getkey() != 'q');
	const char *text2 = "Lalalalalala";
