...
/** 
 * Airline.java
 * This program is meant to implement a fictional airline
 * It is designed to be used by employees of a company to access
 * information on to customers when needed.
 *
...
public class Airline
{
	...
	{	
		...
		String nameOfFile;									// Name of file with flight data as a string 
		...
		System.out.print("Welcome to the Airline program. Please enter the name of the file:   ");		
		nameOfFile = keyboard.nextLine();
		File file = new File(nameOfFile);
		
		while(!file.exists())
		{
			System.out.print("Error: File name entered does not exist. Please enter file that exists:   ");
			nameOfFile = keyboard.nextLine();
		...
		while(userMenuChoice != 9)
		{
			...
			switch( userMenuChoice )
			{
				...
				case 3: 	// Display shortest path based on total miles
				{
					...
					System.out.print("Please enter a source city:  ");
					...
					if (MSPshortestPathDistance.hasPathTo(indexOfDestination)) 
					{
						...
						System.out.println("________________________________________________________________________s");
				...
				case 6: 	// Display paths that cost less than or equal to an amount
				{
					...
					System.out.print("Please enter a cost to see all paths less than or equal to this cost:  ");
				...
				case 7:  	// Add a new route to the schedule
				{
					...
					System.out.print("Please enter a source city of the new route you want to add:  ");
					sourceCity = keyboard.nextLine();
					indexOfSource = Arrays.asList(cities).indexOf(sourceCity);
					if(indexOfSource < 0)
					{
					...
					System.out.print("Please enter a destination city of the new route you want to add:  ");
					destinationCity = keyboard.nextLine();
					indexOfDestination = Arrays.asList(cities).indexOf(destinationCity);
					if(indexOfDestination < 0)
					{
					...
					FileWriter fwriter = new FileWriter(nameOfFile,true);
				...
				case 8: 	// Remove a route from the schedule
				{
					...
					// First we grab the source and destination cities for te new path
					System.out.print("Please enter a source city of the route you want to remove:  ");
					sourceCity = keyboard.nextLine();
					indexOfSource = Arrays.asList(cities).indexOf(sourceCity);
					if(indexOfSource < 0)
					{
					...
					System.out.print("Please enter a destination city of the route you want to remove:  ");
					destinationCity = keyboard.nextLine();
					indexOfDestination = Arrays.asList(cities).indexOf(destinationCity);
					if(indexOfDestination < 0)
					{
    ...
    /**
     * This function displays the options for the main menu to the user.
	 * @return Nothing.
     */
    ...
    /**
     * This method will display the entire list of direct routes to the user
     * @param adjList This is is the adjacency list that contains the edges
	 * @param cities This is the list of cities from the file.
	 * @return Nothing.
     */
    ...
    /**
     * This is a list class used to organize the adjacency list
     */
    ...
    /**
     * This represents the nodes in the List class
     */
    ...
    /**
     * This is code from the Author Robert Sedgewick and Kevin Wayne
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * This is code for the Weighted Edge graph from the textbook
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for linked bag from the textbook
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for Lazy Prim from the textbook
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for Queue from the textbook
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for minPQ from the textbook
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for UnionFind from the textbook
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for Dijkstra's algorithm from the textbook
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for directed edge from the textbook
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for Indexed MinPQ from the book
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for Edge Weighted Digraph from the textbook
     */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for BFS Path algorithm from the textbook
     */
	public static class BreadthFirstPaths {
         ...
         * @param G the graph
		 * @param sourcess The sequence of vertices on a shortest path
         */
         ...
         * @param G the graph
         * @param s the source vertex
         * @return boolean return true if unoptimal, return false if conditions are optimal
         */
	 ...
	 * This is code from the Author Robert Sedgewick and Kevin Wayne
     * Code can be obtained at http://algs4.cs.princeton.edu/home/
     * Code for Generic Graph from the textbook
     */
