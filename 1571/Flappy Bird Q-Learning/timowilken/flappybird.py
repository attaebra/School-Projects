...
import pickle
from learner import State, Agent, ActionSet
import copy

OVERALL_SPEED = 1
FPS = 60
#Pixels per milisecond
ANIMATION_SPEED = 0.18*OVERALL_SPEED
WIN_WIDTH = 284 * 2
WIN_HEIGHT = 512
...
class PipePair(pygame.sprite.Sprite):
    ...
    def __init__(self, pipe_end_img, pipe_body_img):
        ...
        #Compensate for additional pieces
        self.top_pieces += 1
...
def main():
    ...
    while True:
        ...
        pipes = deque()
		#Increments if game is not paused
        frame_clock = 0
        done = paused = False
        curr_run = 0
        old_state = None
        ...
        while not done:
            clock.tick(FPS)
			#This must be handled with pause
            ...
            #If state is different, call learning
            ...
            frame_clock += 1
        runs += 1
        print('Unique States: ', len(agent.Q.history),'\nRuns: ', runs, '\nOverall Points: ', score,  '\nUnique: ', len(up), '\nNaximum Pipes: ', max)
